...
3. Install [**RP2040_RTC** library](https://platformio.org/lib/show/xxxxx/RP2040_RTC) or [**RP2040_RTC** library](https://platformio.org/lib/show/xxxxx/RP2040_RTC) by using [Library Manager](https://platformio.org/lib/show/xxxxx/RP2040_RTC/installation). Search for **RP2040_RTC** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
